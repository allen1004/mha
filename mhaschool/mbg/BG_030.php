			...
			<tr>
				<th class="sub_td">
					<table>
						<tr>
							<th class="sub_td">
								<p class="sub_main_title">'.$bg["3001"]. '</p>
							</th>
						</tr>
						<tr>
							<th style="text-align:right; padding: 0px 50px 0px 0px;">
								<a style="display:none;" id="downloadLink" href="#" download="#"></a>
								<input type="button" class="download" value="'.$bg["1002"].'" onClick="javascript:goDownload(3);">
							</th>
						</tr>
						<tr>
							<th class="sub_td_message">
								<span style="font-size:25px;">'.$bg["3003"].'</span>
							</th>
						</tr>
						<tr>
							<th class="sub_td_message">'.$bg["30031"].'</th>
						</tr>
						<tr>
							<th class="sub_td_message">'.$bg["30032"].'</th>
						</tr>
						<tr><th class="under_line"></th></tr>

						<tr>
							<th class="sub_td_message">
								<span style="font-size:25px;">'.$bg["3004"].'</span>
							</th>
						</tr>
						<tr>
							<th class="sub_td_message">'.$bg["30041"].'</th>
						</tr>
						<tr>
							<th class="sub_td_message">'.$bg["30042"].'</th>
						</tr>
						<tr>
							<th class="sub_td_message">'.$bg["30043"].'</th>
						</tr>
						<tr><td class="under_line"></td></tr>

						<tr>
							<th class="sub_td_message">
								<span style="font-size:25px;">'.$bg["3005"].'</span>
							</th>
						</tr>
						<tr>
							<th class="sub_td_message">'.$bg["30051"].'</th>
						</tr>
						<tr><th class="under_line"></th></tr>

						<tr>
							<th class="sub_td_message">
								<span style="font-size:25px;">'.$bg["3006"].'</span>
							</th>
						</tr>
						<tr>
							<th class="sub_td_message">'.$bg["30061"].'</th>
						</tr>
					</table>
