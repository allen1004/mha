<?php
	...
	$sql_page = "SELECT COUNT(*) AS CNT FROM TB_BOARD_HN020 ORDER BY BB_NO DESC";
	...
	$sql = "
		SELECT 
			...
			, BB_WRT_NM
		FROM TB_BOARD_HN020 ORDER BY BB_NO DESC ".$sqlLimit;
	...
	<table class="sub_table">
		...
		<tr>
			<th class="sub_td_button" style="text-align: right;"><input type="button" class="board-button" value="Write" onClick="javascript:goWrite(2);"></th>
		</tr>
		<tr>
			<th class="sub_td">
	';
	...
	while( $row = $result->fetch_assoc() ) {
		$content .= '
					<tr>
						...
						<td><a href="javascript:goBoradDetail(\'BB_020W.php?no='.$row["BB_NO"].'\', 1, '.$nextPage.');">'.$row["BB_TITLE"].'</a></td>
