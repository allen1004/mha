<?php
	...
	if( $bb_no > 0 && $oo == 99 ) {
		$sql = "SELECT BB_TITLE, BB_MESSAGE, BB_WRT_DT, BB_WRT_NM FROM TB_BOARD_HN020 WHERE BB_NO = $bb_no";
	...
	<table class="sub_table">
		<tr>
			<th class="sub_td">
				<table>
					<tr>
						<th class="sub_td">
							<p class="sub_main_title">행사말씀관리</p>
						</th>
					</tr>
				</table>
			</th>
		...
		<tr>
			<th style="padding: 0px 50px 40px 0px; text-align: right;">
				<input type="button" class="board-button" value="List" onClick="javascript:goSubPage(\'BB_020L.php\', 1);">
				<input type="button" class="board-button" value="Save" onClick="javascript:goBoardEvent(2, 10);">
				<input type="button" class="board-button" value="Modify" onClick="javascript:goBoardEvent(2, 11);">
				<input type="button" class="board-button" value="Delete" onClick="javascript:goBoardEvent(2, 12);">
			</th>
		</tr>
	</table>
